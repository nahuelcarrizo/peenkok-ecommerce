...
import {
  ...
  v4_default,
  visitDiff
} from "./chunk-FWTDN7WX.js";
import {
  require_jsx_runtime
} from "./chunk-QUQV23GG.js";
import {
  require_react
} from "./chunk-5D5IUA7J.js";
import {
  __toESM
} from "./chunk-TFWDKVI3.js";

// node_modules/sanity/lib/_chunks/index-b167003e.js
...
var paneMap = {
  component: (0, import_react.lazy)(() => import("./index-f7e2fcf3-3ZYPV67K.js")),
  document: (0, import_react.lazy)(() => import("./index-04cc5656-33KR4AWB.js")),
  documentList: (0, import_react.lazy)(() => import("./index-7df237fe-CQCVBJPZ.js")),
  list: (0, import_react.lazy)(() => import("./index-58d53f9a-H44EEYFO.js"))
};
...
var Root$5 = styled_components_browser_esm_default(MenuItem)((_ref17) => {
  let {
    state = "enabled",
    isHovered,
    theme
      ...
      subActions: changeAnnotations.length > 0 && (0, import_jsx_runtime.jsx)(Box, {
        ...
        children: (0, import_jsx_runtime.jsx)(DiffTooltip, {
          ...
          children: (0, import_jsx_runtime.jsx)(AvatarStack, {
            maxLength: 4,
            children: changeAnnotations.map((_ref21) => {
              let {
                author
              } = _ref21;
...
var JSONInspectorWrapper = styled_components_browser_esm_default.div((_ref23) => {
  let {
    theme
  } = _ref23;
  const {
...
function PermissionCheckBanner(_ref25) {
  let {
    granted,
    requiredPermission
  } = _ref25;
...
var DocumentPanelHeader = (0, import_react.memo)((0, import_react.forwardRef)((_ref26, ref) => {
  let {
    rootElement
  } = _ref26;
  const {
...
var Scroller = styled_components_browser_esm_default(ScrollContainer)((_ref27) => {
  let {
    $disabled
  } = _ref27;
  if ($disabled) {
...
function DocumentBadgesInner(_ref30) {
  let {
    states
  } = _ref30;
...
var DeskTool = (0, import_react.memo)(function DeskTool2(_ref33) {
  let {
    onPaneChange
  } = _ref33;
  var _a;
  ...
  return (0, import_jsx_runtime.jsxs)(PortalProvider, {
    ...
    children: [(0, import_jsx_runtime.jsxs)(StyledPaneLayout, {
      ...
      children: [paneDataItems.map((_ref34) => {
        let {
          active,
          childItemId,
          groupIndex,
...
function DeskToolBoundary(_ref35) {
  let {
    tool: {
      options
    }
...
//# sourceMappingURL=chunk-CF7TSCK6.js.map
